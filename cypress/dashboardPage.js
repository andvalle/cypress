...
class dashPage {
    ...
    insertName(firstname, middleName, lastName){
    ...
    insertCad(employeID, otherID, driverLicense){
    ...
    insertDate(dateBirth){
        cy.get(this.selectorList().dataField).eq(0).clear().type(dateBirth)
